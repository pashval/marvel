<template>
      <div>
          <div class="marvel-wrapper">
            <div class="title"><span class="title_ch">FIND YOUR COMICS</span></div>
              <div class="form">
                <input placeholder="ultimate spider-man" @keyup.enter="results" v-model="keyword">
  ...
  export default {
    ...
    data() {
       return {
        ...
        dot:  '.',
        total: 0,
        apiURL: 'https://gateway.marvel.com/v1/public/comics?ts=1&',
        error: [],
        keyword: '',
        params: {
    ...
    methods: {
      results() {
          axios.get(this.apiURL+ 'limit=12&' + 'titleStartsWith=' + this.keyword, {params: this.params})
              .then(response => {
